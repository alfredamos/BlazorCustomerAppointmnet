...
{
    public class CustomerSupportDetailsBase : ComponentBase
    {
        [Inject]
        ...
        protected void UpdateCustomerSupport(int customerId)
        {           
            
            NavigationManager.NavigateTo($"/editCustomerSupport/{customerId}");
